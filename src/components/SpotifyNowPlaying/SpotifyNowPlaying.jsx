    ...
    >
      {nowPlaying ? (
        ...
        <motion.a
          ...
          className="flex items-center space-x-3 px-3 py-1.5 rounded-full 
                   bg-gradient-to-r from-green-500/10 to-blue-500/10 hover:from-green-500/20 hover:to-blue-500/20
