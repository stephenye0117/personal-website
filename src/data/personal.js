export const personalInfo = {
  ...
  export const experience = [
    {
      title: "Teacher",
      company: "B3 Bricks, Bots, and Beakers",
      period: "Jun '24 — Aug '24",
      location: "Blacksburg, United States",
      description: [
        "Instructed students in fundamental CS concepts",
        "Facilitated interactive coding projects",
        "Organized technology-themed activities"
      ]
    },
    {
      title: "Intern",
      company: "Shanghai Zhangjiang Institute of Mathematics",
      period: "Dec '23 — Mar '24",
      location: "Shanghai, China (Remote)",
      description: [
        "Developed AI-driven mental health screening",
        "Contributed to conversational AI development",
  ...
  export const skills = {
    ...
    systems: ["Linux", "Mac OS", "IOS", "Windows PowerShell", "Mobile Operating Systems"]
  };